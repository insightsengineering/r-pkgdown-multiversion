...
def process_html_files_in_directory(directory, pattern, refs_order, base_url):
    ...
    dropdown_regex = re.compile(
        r"<!-- start dropdown for versions -->.*<!-- end dropdown for versions -->",
        re.DOTALL,
    )
...
def main():
    parser = argparse.ArgumentParser(
        description="Insert the multi-version drop-down list after the n-th <li> item in unordered lists in all HTML files within a directory."
    )
    parser.add_argument(
